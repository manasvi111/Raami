...
<nav class="navbar navbar-expand-lg navbar-dark ">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="../universal/logout.php">Logout</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
                            ...
                            <tbody>
                                <?php while ($request = $pendingRequests->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../admin/process_request.php?id=<?php echo $request['id']; ?>&action=approve" class="btn btn-success btn-sm">Approve</a>
                                            <a href="../admin/process_request.php?id=<?php echo $request['id']; ?>&action=reject" class="btn btn-danger btn-sm">Reject</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
       ...
       <!-- New Contacts Section -->
                            ...
                            <tbody>
                                <?php while ($contact = $newContacts->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="../admin/mark_as_reviewed.php?id=<?php echo $contact['id']; ?>" class="btn btn-sm btn-review">Mark as Reviewed</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
        ...
        <section id="manage-categories" class="my-5">
            ...
            <form action="../admin/add_category.php" method="POST" class="mb-4">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            while ($category = $categories->fetch_assoc()) {
                                ...
                                echo "<td>";
                                echo "<a href='../admin/edit_category.php?id={$category['id']}' class='btn btn-sm btn-warning'>Edit</a> ";
                                echo "<a href='../admin/delete_category.php?id={$category['id']}' class='btn btn-sm btn-danger'>Delete</a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            ?>
